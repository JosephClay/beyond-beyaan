...
namespace Beyond_Beyaan.Scripts
{
	public class ShipItemScript
	{
		...
		public ShipItemScript(FileInfo filePath)
		{
		...
		public Dictionary<string, object> GetEquipmentInfo(Dictionary<string, object> mainItemValues, Dictionary<string, object>[] modifierItemValues, Dictionary<string, object>[] enhancerItemValues, Dictionary<string, object> shipValues, Dictionary<string, object> modifiableValues)
		{
			return (Dictionary<string, object>)getEquipmentInfo.Invoke(scriptInstance, new Object[] { mainItemValues, modifierItemValues, enhancerItemValues, shipValues, modifiableValues });
		}

...
namespace Beyond_Beyaan.Data_Managers
{
	public class MasterTechnologyManager
	{
		...
		private void LoadWeaponTechs()
		{
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Nuclear Missile", "Missles tipped with nuclear warheads that explode for 4 points of damage and move at a speed of 2.", 1, maximumWeaponDamage: 4, weaponRange: 4, genericCost: 7, genericSize: 50, genericPower: 20, maneuverSpeed: 2, weaponType: Technology.MISSILE_WEAPON));
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Hyper V Rockets", "Swift missiles that explode for 6 points of damage and move at a speed of 2.5", 4, maximumWeaponDamage: 6, weaponRange: 5, genericCost: 9, genericSize: 70, genericPower: 20, maneuverSpeed: 2.5f, weaponType: Technology.MISSILE_WEAPON));
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Hyper X Rockets", "Missiles equipped with high energy warheads that explode for 8 points of damage, move at a speed of 2.5, and are controlled by a +1 level targeting computer.", 8, maximumWeaponDamage: 8, weaponRange: 4, genericCost: 12, genericSize: 100, genericPower: 20, targetingBonus: 1, maneuverSpeed: 2.5f, weaponType: Technology.MISSILE_WEAPON));
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Anti-matter Torpedoes", "High energy tracking torpedoes that deliver 30 points of damage but may only be fired every other turn. Each torpedo is equipped with a +4 level targeting computer.", 23, maximumWeaponDamage: 30, weaponRange: 8, genericCost: 30, genericSize: 75, genericPower: 300, targetingBonus: 4, maneuverSpeed: 4, weaponType: Technology.TORPEDO_WEAPON));
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Pulson Missiles", "Powerful missiles equipped with anti-matter warheads that explode for 20 points of damage, move at speed 4, and are controlled by a +4 level targeting computer.", 29, maximumWeaponDamage: 20, weaponRange: 8, genericCost: 20, genericSize: 160, genericPower: 40, targetingBonus: 4, maneuverSpeed: 4, weaponType: Technology.MISSILE_WEAPON));

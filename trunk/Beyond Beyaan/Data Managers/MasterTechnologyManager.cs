...
namespace Beyond_Beyaan.Data_Managers
{
	public class MasterTechnologyManager
	{
		...
		private void LoadConstructionTechs()
		{
			...
			ConstructionTechs.Add(new Technology("Adamantium Armor", "Increases the hit points of equipped ships by 250% of the original amount (round down). Adds 25 to ground combat rolls. Replaces any other kind of armor on ground combat troops that is lower than itself.", 42, armor: Technology.ADAMANTIUM_ARMOR, smallCost: 10, smallSize: 10, smallHP: 10, mediumCost: 50, mediumSize: 50, mediumHP: 63, largeCost: 250, largeSize: 250, largeHP: 350, hugeCost: 1250, hugeSize: 1250, hugeHP: 2100));
		...
		private void LoadWeaponTechs()
		{
			...
			WeaponTechs.Add(new Technology("Nuclear Missile", "Deals 4 damage to the target. Adds +1 level to the attacker's attack rating for this missile only.", 1, maximumWeaponDamage: 4, weaponRange: 4, genericCost: 7, genericSize: 50, genericPower: 20, weaponType:Technology.MISSILE_WEAPON));
			...
			WeaponTechs.Add(new Technology("Hyper V Rockets", "Deals 6 damage to the target. Adds +1 level to the attacker's attack rating for this missile only.", 4, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Gatling Lasers", "Fires 4 shots per turn. Deals 1 - 4 damage per hit. Requires the same space as 3 lasers.", 5, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			...
			WeaponTechs.Add(new Technology("Neutron Pellet Gun", "Deals 2 - 5 damage, halves the effectiveness of the target's shields.", 7, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Hyper X Rockets", "Deals 8 damage to the target. Adds +1 level to the attacker's attack rating for this missile only.", 8, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Fusion Bomb", "Deals 4 - 16 damage to the target. Can only attack planets.", 9, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Ion Cannon", "Deals 3 - 8 damage to the target, heavy deals 3 - 15 damage to the target with a 2 space range.", 10, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Scatter Pack V Missiles", "Splits into 5 missiles that each deal 6 points of damage to the target.", 11, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Ion Rifle", "Adds 10 to ground combat rolls. Replaces lower level rifle technologies.", 12));
			WeaponTechs.Add(new Technology("Mass Driver", "Deals 5 - 8 damage, halves the effectiveness of the enemy's shields.", 13, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Mercullite Missiles", "Deals 10 damage to the target. Adds +2 level to the attacker's attack rating for this missile only.", 14, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Neutron Blaster", "Regular is 3 - 12 damage with 1 space range. Heavy is 3 - 24 with a 2 space range.", 15, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Anti-matter Bomb", "Deals 5 - 20 damage to the target. Can only attack planets.", 16, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Graviton Beam", "Deals 1 - 15 damage to the target. Damage beyond what is needed to kill the ship transfers to the next ship.", 17, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Stinger Missiles", "Deals 15 damage to the target. Adds + 3 level to the attacker's attack rating for this missile only.", 18, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Hard Beam", "Deals 8 - 12 damage, halves the effectiveness of the enemy's shields.", 19, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Fusion Beam", "Deals 4 - 16 damage with a 1 space range. Also researches Heavy Fusion Beam - Deals 4 - 30 damage with a 2 space range.", 20, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			...
			WeaponTechs.Add(new Technology("Omega Bomb", "Deals 10 - 50 damage to the target. Can only attack planets.", 22, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Anti-matter Torpedoes", "Deals 30 damage, can only be fired every other turn.", 23, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Fusion Rifle", "Adds 15 to ground combat rolls. Replaces lower level rifle technologies.", 24));
			WeaponTechs.Add(new Technology("Megabolt Cannon", "Deals 2 - 20 damage. Wide beam gives the computer a + 3 attack rating when firing this weapon.", 25, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Phasor", "Regular is 5 - 20. Heavy is 5 - 40 with a 2 space range.", 26, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Scatter Pack VII Missiles", "Splits into 7 missiles that each deal 10 points of damage to the target.", 27, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Auto Blaster", "Deals 4 - 16 damage. Fires 3 times per turn.", 28, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Pulson Missiles", "Deals 20 damage to the target. Adds + 4 level to the attacker's attack rating for this missile only.", 29, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Tachyon Beam", "Deals 1 - 25 damage to the target. Damage beyond what is needed to kill the ship transfers to the next ship.", 30, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Fusion Rifle", "Adds 20 to ground combat rolls. Replaces lower level rifle technologies.", 31));
			WeaponTechs.Add(new Technology("Gauss Autocannon", "Deals 7 - 10 damage. Fires 3 times per turn. Halves the effectiveness of the target's shields.", 32, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Particle Beam", "Deals 10 - 20 damage, halves the effectiveness of the enemy's shields.", 33, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Hercular Missiles", "Deals 25 damage to the target. Adds + 5 level to the attacker's attack rating for this missile only.", 34, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Plasma Cannon", "Deals 6 - 30 damage.", 35, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Disruptor", "10 - 40 damage, Range 2.", 37, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Pulse Phasor", "Deals 5 - 20 damage. Fires 3 times per turn.", 38, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Neutronium Bomb", "Deals 40 - 70 damage. Can only attack planetary targets.", 39, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Hellfire Torpedoes", "Deals 4 attacks to the target per hit, each for 25 damage. Fires every other turn.", 40, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Zeon Missiles", "Deals 30 damage to the target. Adds + 7 level to the attacker's attack rating for this missile only.", 41, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Plasma Rifle", "Adds 30 to ground combat rolls. Replaces lower level rifle technologies.", 42));
			WeaponTechs.Add(new Technology("Proton Torpedoes", "Deals 75 damage to the target. Fires once every other turn.", 43, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Scatter Pack X Missiles", "Splits into 10 missiles that each deal 15 points of damage to the target.", 44, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Tri Focus Plasma Cannon", "Deals 20 - 50 damage.", 45, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Stellar Converter", "Deals 4 attacks to the target, each dealing 10 - 35 damage.", 46, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			...
			WeaponTechs.Add(new Technology("Mauler Device", "Deals 20 - 100 damage.", 48, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
			WeaponTechs.Add(new Technology("Plasma Torpedoes", "Deals 150 damage to the target. Fires every other turn. Damage is reduced by 15 for each space travelled.", 50, secondaryName: "Heavy Laser", minimumWeaponDamage: 1, maximumWeaponDamage: 4, weaponRange: 1, genericCost: 3, genericSize: 10, genericPower: 25, minimumSecondaryWeaponDamage: 1, maximumSecondaryWeaponDamage: 7, genericSecondaryCost: 9, genericSecondarySize: 30, genericSecondaryPower: 75, secondaryWeaponRange: 2));
		}
		#endregion

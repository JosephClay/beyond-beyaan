...
namespace Beyond_Beyaan.Data_Managers
{
	public class MasterTechnologyManager
	{
		...
		private void LoadWeaponTechs()
		{
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Nuclear Missile", "Missles tipped with nuclear warheads that explode for 4 points of damage and move at a speed of 2.", 1, maximumWeaponDamage: 4, weaponRange: 4, genericCost: 7, genericSize: 50, genericPower: 20, missileSpeed: 2, weaponType: Technology.MISSILE_WEAPON));
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Hyper V Rockets", "Swift missiles that explode for 6 points of damage and move at a speed of 2.5", 4, maximumWeaponDamage: 6, weaponRange: 5, genericCost: 9, genericSize: 70, genericPower: 20, missileSpeed: 2.5f, weaponType: Technology.MISSILE_WEAPON));
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Hyper X Rockets", "Missiles equipped with high energy warheads that explode for 8 points of damage, move at a speed of 2.5, and are controlled by a +1 level targeting computer.", 8, maximumWeaponDamage: 8, weaponRange: 4, genericCost: 12, genericSize: 100, genericPower: 20, targetingBonus: 1, missileSpeed: 2.5f, weaponType: Technology.MISSILE_WEAPON));
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Stinger Missiles", "Slow, hyper-accurate missiles that do 15 points of damage, move at a speed of 3.5, and are controlled by a sophisticated +3 level targeting computer.", 18, maximumWeaponDamage: 15, weaponRange: 7, genericCost: 19, genericSize: 155, genericPower: 30, targetingBonus: 3, missileSpeed: 3.5f, weaponType: Technology.MISSILE_WEAPON));
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Scatter Pack X Missiles", "Mirv versions of Stinger Missiles, splitting into ten separate warheads that each explode for 15 points of damage, move at speed 3.5, and are guided by a +3 level targeting computer.", 44, maximumWeaponDamage: 15, weaponRange: 7, genericCost: 30, genericSize: 250, genericPower: 50, numberOfShots: 10, targetingBonus: 3, missileSpeed: 3.5f, weaponType: Technology.MISSILE_WEAPON));

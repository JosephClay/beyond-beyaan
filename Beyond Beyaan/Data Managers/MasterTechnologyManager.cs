...
namespace Beyond_Beyaan.Data_Managers
{
	public class MasterTechnologyManager
	{
		...
		private void LoadWeaponTechs()
		{
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Nuclear Missile", "Missles tipped with nuclear warheads that explode for 4 points of damage and move at a speed of 2.", 1, maximumWeaponDamage: 4, weaponRange: 4, genericCost: 5, genericSize: 50, genericPower: 20, missileSpeed: 2, weaponType: Technology.MISSILE_WEAPON));
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Hyper V Rockets", "Swift missiles that explode for 6 points of damage and move at a speed of 2.5", 4, maximumWeaponDamage: 6, weaponRange: 5, genericCost: 7, genericSize: 70, genericPower: 20, missileSpeed: 2.5f, weaponType: Technology.MISSILE_WEAPON));
			...
			WeaponTechs.Add(new Technology(TechField.WEAPON, "Stinger Missiles", "Slow, hyper-accurate missiles that do 15 points of damage, move at a speed of 3.5, and are controlled by a sophisticated +3 level targeting computer.", 18, maximumWeaponDamage: 15, weaponRange: 7, genericCost: 15, genericSize: 155, genericPower: 30, targetingBonus: 3, missileSpeed: 3.5f, weaponType: Technology.MISSILE_WEAPON));
